...
// for - Цикл, вывод элементов массива без использования методов
...
// ЕСЛИ НУЖНО ОБРАБОТАТЬ ДАННЫЕ 1 РАЗ В КОДЕ - ИСПОЛЬЗУЙ forEach
// ЕСЛИ НУЖНО ОБРАБОТАТЬ ДАННЫЕ И СОХРАНИТЬ ИХ - ИСПОЛЬЗУЙ map
